            ...
            <div style="height: 400px" class="modal-body">
                <form onsubmit="return validate_goods_add();" id="new-goods-form" method="post" action="market/post" enctype="multipart/form-data"> <!--enctype for multiple upload -->
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            <label>City</label>
                            <input value="sdfdsfsdf" name="m_p_city" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Region</label>
                            <input value="sdfdsfsdf" name="m_p_region" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Car brand</label>
                            <input value="sdfdsfsdf" name="m_p_brand" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input value="sdfdsfsdf" name="m_p_model" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Engine capacity</label>
                            <input value="sdfdsfsdf" name="m_p_capacity" type="text" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Mileage</label>
                            <input value="sdfdsfsdf" name="m_p_mileage" type="date"  class="form-control">
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input value="sdfdsfsdf" name="m_p_owners" type="date"  class="form-control">
                        </div>
                        <div class="form-group">
